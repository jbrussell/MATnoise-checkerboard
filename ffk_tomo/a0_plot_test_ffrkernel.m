...
snr_tol = parameters.snr_tol; % minimum signal-to-noise
r_tol_min = parameters.r_tol_min; % [km] minimum station separation
r_tol_max = parameters.r_tol_max; % [km] maximum station separation
...
wl_fac = parameters.wl_fac; % determine distance tolerance by wavelength?
dep_tol = parameters.dep_tol; % [sta1 sta2] OBS depth tolerance
...
min_dep = parameters.min_dep; %-3500 for min station depth to use
